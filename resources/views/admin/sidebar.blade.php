<nav class="sidebar sidebar-offcanvas" id="sidebar">
    ...
    <ul class="nav">
            ...
            <div class="profile-desc">
                <div class="profile-pic">
                    ...
                    <div class="profile-name">
                        <h5 class="mb-0 font-weight-normal">NASAAZI TAKIA</h5>
        ...
        <li
            class="nav-item menu-items {{ request()->is('view_attempts', 'view_schools', 'view_students') ? 'active' : '' }}">
        ...
        <li
            ...
            <a class="nav-link" href="{{ url('analytics ') }}">
                ...
                <span class="menu-title">Best Answered Questions</span>
            </a>
        </li>
    </ul>
</nav>
