    ...
    <div class="container-fluid page-body-wrapper">
        <div class="container" style="color: black; padding-top: 50px;" align="center">
            <form action="{{ url('addschool') }}" method="POST" enctype="multipart/form-data" class="needs-validation"
                ...
                <div class="form-group row">
                    <label for="registration_number" class="col-sm-4 col-form-label text-right">Registration
                        Number</label>
                    <div class="col-sm-8">
                ...
                <div class="form-group row">
                    <label for="representative_name" class="col-sm-4 col-form-label text-right">Representative
                        Name</label>
                    <div class="col-sm-8">
                ...
                <div class="form-group row">
                    <label for="representative_email" class="col-sm-4 col-form-label text-right">Representative
                        Email</label>
                    <div class="col-sm-8">
